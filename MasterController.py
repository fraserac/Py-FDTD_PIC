...
class CPML_Variables(object):
    ...
    def __init__(self, kappa_Ex, kappa_Hy, psi_Ex, psi_Hy, alpha_Ex, alpha_Hy, sigmaEx, sigmaHy, bev, bmv, cev, cmv ):
...
C_V = CPML_Variables(kappa_Ex, kappa_Hy, psi_Ex, psi_Hy, alpha_Ex, alpha_Hy, sigmaEx, sigmaHy,bev, bmv, cev, cmv)
...
#kappaMax, sigmaEMax, sigmaHMax, sigmaOpt, bev, bmv, cev, cmv, alphaMax, r_scale, r_a_scale

##CPML Vars

#kappa_Ex, kappa_Hy, psi_Ex, psi_Hy, alpha_Ex, alpha_Hy, sigmaEx, sigmaHy, bev, bmv, ceX, cmY
